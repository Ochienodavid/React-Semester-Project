...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    email: 'ochienodavid@iuea.ac.ug',
    phone: '+256 760 552 913',
    address: {
      line1: "Plot 379 Kololo Upper Terrace",
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div className='mt-10'>
        {
        isEdit
          ? <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all' onClick={() => setIsEdit(false)}>Save Changes</button>
